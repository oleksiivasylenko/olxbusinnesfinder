namespace OlxParser
{
    public static class GVars
    {
        ...
        {
            public static string LabelLinksLoaded (int loaded, int allCount) => $"{loaded} links loaded. All - {allCount}";

            public static string LabelOrdersLoaded(int loaded, int allCount) => $"{loaded} orders loaded. All - {allCount}";
        }
